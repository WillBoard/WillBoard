...
namespace WillBoard.Web
{
    public static class Routing
    {
        ...
        {
            RegisterApi(webApplication);
            RegisterAdministrationApi(webApplication);
            RegisterAdministration(webApplication);
            RegisterBoard(webApplication);
            RegisterApplication(webApplication);
        }

        private static void RegisterApi(WebApplication webApplication)
        {
        ...
        private static void RegisterAdministrationApi(WebApplication webApplication)
        {
            webApplication.MapControllerRoute(
        ...
        private static void RegisterAdministration(WebApplication webApplication)
        {
            webApplication.MapControllerRoute(
            ...
            webApplication.MapControllerRoute(
                ...
                constraints: new { boardId = _boardId, ipVersion = _int, ipNumber = _uInt128 }
            ).WithMetadata(new EndpointResponse(EndpointContentType.HTML));
        ...
        private static void RegisterBoard(WebApplication webApplication)
        {
            webApplication.MapControllerRoute(
        ...
        private static void RegisterApplication(WebApplication webApplication)
        {
            webApplication.MapControllerRoute(
                name: "",
                pattern: "",
