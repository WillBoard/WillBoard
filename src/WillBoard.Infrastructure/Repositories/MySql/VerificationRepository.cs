...
namespace WillBoard.Infrastructure.Repositories.MySql
{
    public class VerificationRepository : IVerificationRepository
    {
        ...
        public async Task<IEnumerable<Verification>> ReadSystemUnexpiredCollectionAsync(IpVersion ipVersion, BigInteger ipNumber)
        {
            using (var dbConnection = _sqlConnectionService.Connection)
            {
        ...
        public async Task<IEnumerable<Verification>> ReadBoardUnexpiredCollectionAsync(string boardId, IpVersion ipVersion, BigInteger ipNumber)
        {
            using (var dbConnection = _sqlConnectionService.Connection)
            {
