...
{
    public class TranslationUpdateCommandHandler : IRequestHandler<TranslationUpdateCommand, Status<InternalError>>
    {
        private readonly AccountManager _accountManager;
        private readonly ITranslationRepository _translationRepository;
        private readonly ITranslationCache _translationCache;

        public TranslationUpdateCommandHandler(AccountManager accountManager, ITranslationRepository translationRepository, ITranslationCache translationCache)
        {
        ...
        public async ValueTask<Status<InternalError>> Handle(TranslationUpdateCommand request, CancellationToken cancellationToken)
        {
            ...
            var translationUpdate = new Translation()
            {
            ...
            await _translationRepository.UpdateAsync(translationUpdate);
