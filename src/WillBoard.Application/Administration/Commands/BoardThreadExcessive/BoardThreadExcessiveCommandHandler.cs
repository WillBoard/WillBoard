...
{
    public class BoardThreadExcessiveCommandHandler : IRequestHandler<BoardThreadExcessiveCommand, Status<InternalError>>
    {
        ...
        public BoardThreadExcessiveCommandHandler(AccountManager accountManager, IPostRepository postRepository, IBoardCache boardCache, IPostCache postCache)
        {
        ...
        public async ValueTask<Status<InternalError>> Handle(BoardThreadExcessiveCommand request, CancellationToken cancellationToken)
        {
            ...
            await _postRepository.UpdateExcessiveAsync(post.BoardId, post.PostId, request.Excessive);
