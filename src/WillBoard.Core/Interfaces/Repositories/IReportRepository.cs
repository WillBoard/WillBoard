...
namespace WillBoard.Core.Interfaces.Repositories
{
    public interface IReportRepository
    {
        ...
        Task<IEnumerable<Report>> ReadSystemIPCollectionAsync(IpVersion ipVersion, UInt128 ipNumber);
        ...
        Task<IEnumerable<Report>> ReadBoardIPCollectionAsync(string boardId, IpVersion ipVersion, UInt128 ipNumber);
